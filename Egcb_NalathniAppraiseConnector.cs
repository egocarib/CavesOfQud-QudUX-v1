...
{
    public class NalathniAppraiseConnector
    {
                ...
                if (this._bCanAppraise == null)
                {
                    ...
                    if (this._bCanAppraise == true)
                    {
                        ...
                        catch (Exception ex)
                        {
                            ...
                            if (!NalathniAppraiseConnector._bExceptionLogged)
                            {
                                NalathniAppraiseConnector._bExceptionLogged = true;
        ...
        public NalathniAppraiseConnector()
        {
            if (NalathniAppraiseConnector._bInitialized != true)
            {
                NalathniAppraiseConnector._bInitialized = true;
                if (SkillFactory.Factory.SkillByClass.ContainsKey("Customs"))
                {
                    if (SkillFactory.Factory.SkillByClass["Customs"].Powers.ContainsKey("Appraisal"))
                    {
                        ...
                        {
                            NalathniAppraiseConnector._bAppraiseSkillExists = true;
